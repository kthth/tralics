...
\\endsec (tralics command) {#cmd-endsec}
--------------------------
...
Preview ![example of eqnarray](/img/img_100.png)
...
See also the [split](doc-s.html#env-split) environment.
...
\\exhyphenpenalty (internal integer) {#cmd-exhyphenpenalty}
------------------------------------
